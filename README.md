...
The process of installing Skylands is very similar to how you would normally install a pack (you can find instructions on how to do that [here](https://terra.polydev.org/config/pack-installation.html). However, instead of using the ID OVERWORLD, simply replace it with SKYLANDS
